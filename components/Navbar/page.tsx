      ...
      <div className='flex flex-col md:flex-row bg-white rounded-[20px]'>
        <div className='flex flex-col md:flex-row w-full md:justify-between items-center px-[12px] md:px-[24px] py-[24px]'>
          ...
          <div className='flex items-center gap-[12px]'>
            ...
            <div title="Clock" className='flex items-center rounded-[40px] border border-[#3D39361A] py-[4px] pl-[12px] pr-[4px] gap-[16px] hover:scale-105 transition-transform cursor-default'>
              <Image src="/Navbar/Clock.svg" alt="Clock" width={24} height={24} />
              <p className='text-[#3D3936] min-w-[60px]'>{time || "00:00:00"}</p>
              <Image src="/Navbar/Note.svg" alt="Note" width={40} height={40} className="cursor-pointer hover:scale-110 transition-transform" title="Notes" />
            </div>
